...
int main()
{
	...
	do{ 
		...
		fstream cod;
		denumire_HTML=denumire+".html";
		cod.open(denumire_HTML, ios::out);
		...
		cod<<"<text x=\"" <<pozx<<"\" y=\"10\" fill=\"black\" style='font-weight: bold'>"<<denumire<<"</text>";
		...
		char htmlFile[] = "D:\\DSUsers\\bozdogl\\MASTER\\CP\\incercari\\";
		const char *denum = denumire_HTML.c_str();
